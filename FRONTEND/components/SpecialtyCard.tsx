    ...
    >
      ...
      <div>
        ...
        <h3 className={`text-xl font-extrabold mb-3 transition-colors relative z-10 leading-snug tracking-tight ${
          isActive ? 'text-slate-900' : 'text-slate-900 group-hover:text-[#0E7C66]'
        }`}>
          {name}
        </h3>
      ...
      <div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#0E7C66]/60 to-transparent transition-transform duration-500 scale-x-0 ${
