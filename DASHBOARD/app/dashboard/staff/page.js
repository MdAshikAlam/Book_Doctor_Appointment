        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/60 animate-in fade-in duration-200 space-y-4 max-w-md mx-auto">
                <div className="text-center">
                  ...
                  <p className="text-[10px] text-slate-400 mt-1 font-bold">
                    Enter 6-digit OTP code sent to email. {otpTimer > 0 ? `(Expires in ${formatTime(otpTimer)})` : <span className="text-rose-500 font-bold">(Expired)</span>}
                  </p>
                </div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            <Button 
              type="submit" 
              disabled={!emailVerified}
              className="flex-[2] h-12 bg-slate-900 text-white font-bold rounded-2xl shadow-lg shadow-slate-200 disabled:bg-slate-300 disabled:shadow-none"
            >
